...
case 'OperationCode'
    CreateString = ['CREATE TABLE OperationCode ' ...
        ...
        'IsSubsidiary TINYINT(1), ' ... % labels whether the code is actually in database (0) or just a subsidiary piece of code (1)
        'Description TEXT, ' ...
        'fdepDone TINYINT(1), ' ... % Whether fdep has been run on this to analyze for functional dependencies
...
case 'CodeSource'
    CreateString = ['CREATE TABLE CodeSource ' ...
        ...
        'Name VARCHAR(255), ' ... % A name given to the code source
        'Description TEXT, ' ... % A description of the code source
        'LicenseType INTEGER UNSIGNED, ' ... % An integer label for the license type
        'Ncodes INTEGER UNSIGNED, ' ... % Counts the number of pieces of code with this source name
        'LastModified TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ' ...
        'PRIMARY KEY (tb_id))'];
